...
class ImportExportService {
    ...
    func exportSettings(
        ...
        do {
            ...
            savePanel.nameFieldStringValue = "Wa-Gong_Settings_Backup.json"
            savePanel.title = String(localized: "Export Wa-Gong Settings")
    ...
    func importSettings(
        ...
        openPanel.title = String(localized: "Import Wa-Gong Settings")
    ...
    private func showImportSuccessAlert(message: String, needsAPIKeyReminder: Bool) {
        DispatchQueue.main.async {
            ...
            informativeText +=
                "\n\n" + String(localized: "It is recommended to restart Wa-Gong for all changes to take full effect.")
