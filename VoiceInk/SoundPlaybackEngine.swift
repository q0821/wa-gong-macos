...
final class SoundPlaybackEngine: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "com.jackie-yeh.wagong.soundPlayback", qos: .userInitiated)
    private let logger = Logger(subsystem: "com.jackie-yeh.wagong", category: "SoundPlaybackEngine")
