...
struct SettingsView: View {
    ...
    var body: some View {
        Form {
            ...
            Section("Pasting") {
                ExpandableSettingsRow(
                    ...
                    infoMessage:
                        "Wa-Gong temporarily uses the clipboard to paste transcription. When enabled, it restores your previous clipboard content after the selected delay. When disabled, the pasted transcription stays on your clipboard."
                ) {
        ...
        .alert("Restart Wa-Gong to Apply Language", isPresented: $showLanguageRestartAlert) {
            Button("OK", role: .cancel) {}
        } message: {
            Text("Your language change will take full effect after you quit and reopen Wa-Gong.")
        }
    }
