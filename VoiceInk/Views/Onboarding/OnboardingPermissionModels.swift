...
enum OnboardingStage: String, CaseIterable {
    ...
    var title: String {
        ...
        case .experience:
            return String(localized: "Experience Wa-Gong")
        case .contextAwareness:
            return String(localized: "Wa-Gong is Context-Aware")
        case .trust:
            return String(localized: "Wa-Gong is Open Source")
        }
    }
    ...
    var subtitle: String {
        switch self {
        case .permissions:
            return String(localized: "Allow Wa-Gong to work across all your apps.")
        case .microphone:
        ...
        case .api:
            return String(
                localized:
                    "Wa-Gong uses LLMs to enhance transcripts and perform AI actions. Set up an API key before continuing."
            )
        case .experience:
            return String(localized: "Try a few short samples and see how Wa-Gong works before you start.")
        case .contextAwareness:
            return String(
                localized: "Wa-Gong can select the right mode from the app you are using and the rules you configure.")
        case .trust:
            return String(localized: "Wa-Gong is private by default. No data leaves your device unless you opt in.")
        }
    }
    ...
    var descriptor: OnboardingPermissionDescriptor {
        ...
        case .microphone:
            return OnboardingPermissionDescriptor(
                title: "Microphone",
                subtitle: String(localized: "Wa-Gong uses your microphone to capture your voice.")
            )

        case .accessibility:
            return OnboardingPermissionDescriptor(
                title: String(localized: "Accessibility"),
                subtitle: String(localized: "Wa-Gong uses Accessibility to type transcriptions directly into any app.")
            )
        ...
        case .screenRecording:
            return OnboardingPermissionDescriptor(
                ...
                subtitle: String(
                    localized: "Wa-Gong reads visible screen content to improve the accuracy of transcripts.")
            )
        }
    }
}
