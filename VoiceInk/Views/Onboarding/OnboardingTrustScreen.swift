...
struct OnboardingTrustScreen: View {
    ...
    var body: some View {
        OnboardingStepScreen(
            ...
            subtitle: "Review how Wa-Gong handles your data before you start.",
...
private struct TrustHeader: View {
    var body: some View {
        VStack(spacing: 16) {
            ...
            Text("Wa-Gong is private by default")
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            VStack(spacing: 10) {
                ...
                Text("Wa-Gong is also open source, so you can inspect every single line of code.")
                    .font(.system(size: 13))
